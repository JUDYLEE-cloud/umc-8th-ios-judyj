...
struct FindMapVIew: View {
    ...
    @Binding var isMapRouteLoading: Bool
    
    @Binding var selectedTab: Int
    public init(isShowingNoneResultAlert: Binding<Bool>, selectedTab: Binding<Int>, viewModel: RouteViewModel, isMapRouteLoading: Binding<Bool>) {
        self._isShowingNoneResultAlert = isShowingNoneResultAlert
        self._selectedTab = selectedTab
        self.viewModel = viewModel
        self._isMapRouteLoading = isMapRouteLoading
    }
...
#Preview {
    FindMapVIew(
        ...
        isMapRouteLoading: .constant(false)
    )
}
